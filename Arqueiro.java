// Classe Arqueiro que herda da classe Player
public class Arqueiro extends Player {
	private static final int destreza_base = 50; //Define a chance de ataque crítico
    private static final int vida_base = 45; //Vida inicial do guerreiro
    private static final int ataque_base = 13; //Poder de ataque inicial
    private static final int defesa_base = 5; //Capacidade de defesa
    private static final int velocidade_base = 8;  //Critério de prioridade na lista de ataque
    
    //Construtor da classe Arqueiro, passando os atributos base para o construtor da superclasse Player
    public Arqueiro(String nome) {
        super(destreza_base, vida_base, ataque_base, defesa_base, velocidade_base, nome);
    }
    
    //Método que define como o Arqueiro realiza um ataque
    @Override
    ...
    //Representação do Arqueiro com suas principais estatísticas
    @Override
