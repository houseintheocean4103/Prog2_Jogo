// Classe Guerreiro que herda da classe Player
public class Guerreiro extends Player {
	private static final int destreza_base = 40; //Define a chance de ataque crítico
    private static final int vida_base = 55; //Vida inicial do guerreiro
    private static final int ataque_base = 16; //Poder de ataque inicial
    private static final int defesa_base = 10; //Capacidade de defesa
    private static final int velocidade_base = 10; //Critério de prioridade na lista de ataque

    
    //Construtor da classe Guerreiro, passando os atributos base para o construtor da superclasse Player
    public Guerreiro(String nome) {
        super(destreza_base, vida_base, ataque_base, defesa_base, velocidade_base, nome);
    }
    
    //Método que define como o Guerreiro realiza um ataque
    @Override
    ...
    //Representação do Guerreiro com suas principais estatísticas
    @Override
