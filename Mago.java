// Classe Mago que herda da classe Player
public class Mago extends Player {
	private static final int destreza_base = 33; //Define a chance de ataque crítico
    private static final int vida_base = 50; //Vida inicial do guerreiro
    private static final int ataque_base = 15; //Poder de ataque inicial
    private static final int defesa_base = 14; //Capacidade de defesa
    private static final int velocidade_base = 12; //Critério de prioridade na lista de ataque

    
    //Construtor da classe Mago, passando os atributos base para o construtor da superclasse Player
    public Mago(String nome) {
        super(destreza_base, vida_base, ataque_base, defesa_base, velocidade_base, nome);
    }
    
    //Método que define como o Mago realiza um ataque
    @Override
    ...
    //Representação do Mago com suas principais estatísticas
    @Override
