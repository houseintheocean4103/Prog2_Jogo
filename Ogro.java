// Classe Ogro que herda da classe Player
public class Ogro extends Player {
	private static final int destreza_base = 10; //Define a chance de ataque crítico
    private static final int vida_base = 70; //Vida inicial do guerreiro
    private static final int ataque_base = 14; //Poder de ataque inicial
    private static final int defesa_base = 7; //Capacidade de defesa
    private static final int velocidade_base = 2; //Critério de prioridade na lista de ataque

    
    //Construtor da classe Ogro, passando os atributos base para o construtor da superclasse Player
    public Ogro(String nome) {
        super(destreza_base, vida_base, ataque_base, defesa_base, velocidade_base, nome);
    }
    
    //Método que define como o Ogro realiza um ataque
    @Override
    ...
    //Representação do Ogro com suas principais estatísticas
    @Override
